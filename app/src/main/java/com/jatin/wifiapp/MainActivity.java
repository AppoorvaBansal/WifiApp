...
public class MainActivity extends AppCompatActivity {
        ...
        btnDiscover.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               // list.clear();
                ...
                getApplicationContext().registerReceiver(myWifiDevicesReceiver,intentFilter);
    ...
    private BroadcastReceiver myWifiDevicesReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if(success)
            {
                Toast.makeText(getApplicationContext(),"findd",Toast.LENGTH_LONG).show();
                ...
                Toast.makeText(getApplicationContext(),"FAILED Failed",Toast.LENGTH_LONG).show();
